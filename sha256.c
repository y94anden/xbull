...
/*
    compress 512-bits
 */
static void sha256_compress(struct psSha256_t *sha256, const unsigned char *buf)
{
...
#   define RND(a, b, c, d, e, f, g, h, i)                          \
    t0 = h + Sigma1(e) + Ch(e, f, g) + pgm_read_dword_near(K+i) + W[i]; \
 ...
 */
    ...
    memset(sha256, 0x0, sizeof(struct psSha256_t));
}

# ifdef USE_SHA224
/******************************************************************************/

void psSha224Init(struct psSha256_t *sha256)
{
    sha256->curlen = 0;
    sha256->lengthHi = 0;
    sha256->lengthLo = 0;
...
void psSha224Update(struct psSha256_t *sha256, const unsigned char *buf, uint32 len)
{
...
void psSha224Final(struct psSha256_t *sha256, unsigned char out[SHA224_HASHLEN])
{
